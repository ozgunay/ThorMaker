...
AC_DEFUN(
	...
	AC_MSG_NOTICE([Checking Boost CoRoutine Version])
	    ...
	    [
	     AC_MSG_NOTICE([Checking Boost CoRoutine Version V1 FAIL])
            ]
        )
        AC_COMPILE_IFELSE(
	    ...
	    [
	     AC_MSG_NOTICE([Checking Boost CoRoutine Version V2 FAIL])
            ]
        )
        AC_COMPILE_IFELSE(
	     ...
	     AC_DEFINE([BOOST_COROUTINE_VERSION],[3],[Define which version of the boost co-routines we are using])
	     AC_MSG_NOTICE([Checking Boost CoRoutine Version V3 OK])
            ],
	    [
	     AC_MSG_NOTICE([Checking Boost CoRoutine Version V3 FAIL])
            ]
        )
